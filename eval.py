...
tf.app.flags.DEFINE_string('eval_dir', '/home/khc/MLProject',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'train_eval',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '/home/khc/MLProject',
                           """Directory where to read model checkpoints.""")
tf.app.flags.DEFINE_integer('eval_interval_secs', 5,
                            """How often to run the eval.""")
tf.app.flags.DEFINE_integer('num_examples', 28709,
...
def eval_once(saver, top_k_op):
  with tf.Session() as sess:
    ...
    try:
      ...
      print('%s: precision @ 1 = %.3f, true_count = %d, total_sample_count = %d, t=%d'
             % (datetime.now(), precision, true_count, total_sample_count, t))
      summary = tf.Summary()
